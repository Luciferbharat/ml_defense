# ML Defense (Customized by Bharat Patel)
This project is customized and documented for learning and demonstration purposes.

## What’s new
- Added documentation and comments for better understanding.
- Experimented with defense methods and results visualization.
- Improved repo description and setup instructions.
